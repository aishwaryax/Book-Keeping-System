                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
    {!! Form::open(['action' => [ 'BooksController@update', $b->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}

                                        <div class="row">
                                            <div class="col-md-5 pr-1">
                                                <div class="form-group">
                                                    {{Form::label('book_id_text','Book ID')}}
                                                    {{Form::text('book_id', $b->id,['class'=>'form-control','placeholder'=>'Enter Book ID'])}}
                                                </div>
                                            </div>
                                            <div class="col-md-3 px-1">
                                                <div class="form-group">
                                                    {{Form::label('name_text','Name')}}
                                                    {{Form::text('name', $b->title,['class'=>'form-control','placeholder'=>'Name . . .'])}}
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-4 pl-1">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('author', $b->author,['class'=>'form-control','placeholder'=>'Author name'])}}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 pl-1">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::text('lang', $b->lang,['class'=>'form-control','placeholder'=>'Language'])}}
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 px-5">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::Number('shelf_no',$b->shelf_no,['class'=>'form-control','placeholder'=>'Enter shelf no . . .'])}}
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 px-5">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::Number('copies', $b->copies,['class'=>'form-control','placeholder'=>'Enter copies . . .'])}}
                                                </div>
                                            </div>
                                            </div>
                                            <div class=row>
                                            <div class="col-md-6 px-5">
                                                <div class="form-group">
                                                    ...
                                                    {{Form::Number('price', $b->price,['class'=>'form-control','placeholder'=>'Enter price . . .'])}}
                                                </div>
                                            </div>
