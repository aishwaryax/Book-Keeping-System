    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
    {!! Form::open(['action' => 'DonorsController@store', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="pan_no" class="col-md-4 col-form-label text-md-right">{{ __('Pan Number') }}</label>

                            <div class="col-md-6">
                                <input id="pan_no" type="text"  class="form-control @error('pan_no') is-invalid @enderror" name="pan_no" value="{{ old('pan_no') }}"   maxlength="10" required autocomplete="pan_no">
